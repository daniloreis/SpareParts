...
namespace SparePartsApp.Components
{
    ...
    public class BarCodeEntry : NumericEntry
    {
        public BarCodeEntry()
        {
            TextChanged += BarCodeEntry_TextChanged;
        }
        ...
        private void BarCodeEntry_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (e.NewTextValue != null)
            {
                ...
                if (e.NewTextValue != "" && e.NewTextValue != Text)
                {
                    (sender as BarCodeEntry).SendCompleted();
                    Text = "";
                }
            }
#endif
    ...
    {
        BoxView boxBackground = new BoxView { HeightRequest = 22, WidthRequest = 22, BackgroundColor = Color.LightGray, VerticalOptions = LayoutOptions.CenterAndExpand };
